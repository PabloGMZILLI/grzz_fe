				...
				<View style={styles.container}>
					<View style={styles.avatar}>
						...
						<View style={{ marginLeft: 20, marginTop: 0 }}>
							<Text style={{ fontSize: 35 }}>{item.name[0].toUpperCase() + item.name.substr(1)} {item.lastname[0].toUpperCase() + item.lastname.substr(1)}</Text>
					...
					<View>
						...
						<View style={{ flexDirection: 'row' }}>
							...
							<View style={{ marginLeft: 20 }}>
								...
								<Text h4>Tipo de avaliacao: {item.workspace}</Text>
							</View>
						</View>
					</View>
					<Divider style={{ marginVertical: 10 }} />
